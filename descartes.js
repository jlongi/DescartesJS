...
descartesJS.Equation.prototype.Singularity = function(e, X, F, a, va, b, vb, minmax) {
  ...
  descartesJS.Equation.prototype.drawAuxFun = function(ctx, fill, stroke) {
    ...
    while (x <= condWhile) {
      ...
      try {
        v = this.evaluator.evalExpression(this.funExpr);
...
// console.log(this.evaluator.getVariable(X), "***", v, "***", sing)
...
var descartesJS = (function(descartesJS) {
  ...
  descartesJS.Space2D = function(parent, values) {
    ...
    if ((self.id !== "") && (parent.version !== 2)) {
      ...
      self.kpressedString = self.id + ".key_pressed";
      self.kvalueString   = self.id + ".key_value";
    }
    else {
      self.OxString    = "Ox";
      self.OyString    = "Oy";
      ...
      self.kpressedString = "key_pressed";
      self.kvalueString   = "key_value";
    }
