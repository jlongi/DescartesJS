...
var descartesJS = (function(descartesJS) {
  ...
  class SpaceExternal {
    ...
    constructor(parent) {
      ...
      self.container = descartesJS.newHTML("div", {
        style : `box-sizing:border-box;border-style:ridge;border-width:5px;border-color:gray;box-shadow:#000 0 0 25px 5px;overflow-y:scroll;overflow-x:hidden;position:fixed;left:0;top:0;z-index:10000;background-color:#63b4fb;width:${self.width +27}px;height:460px;`,
      });

      self.movable = descartesJS.newHTML("div", {
        style : `position:absolute;left:0;top:0;width:${self.width +27}px;height:${self.vSpace}px;line-height:${self.vSpace}px;background-color:#ddd;cursor:move;padding-left:75px;font-family:${descartesJS.sansserif_font};font-size:18px;`,
      });
  ...
  descartesJS.SpaceExternal = SpaceExternal;
  return descartesJS;
})(descartesJS || {});
