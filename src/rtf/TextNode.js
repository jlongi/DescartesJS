...
var descartesJS = (function(descartesJS) {
  ...
  class TextNode {
    ...
    constructor(value, nodeType, style, evaluator) {
      ...
      this.drawBorder = (descartesJS.in_editor) ? this.drawBorderSpecial : function() {};
    }
      ...
      if ((this.nodeType === "textLineBlock") || (this.nodeType === "word")) {
        ...
        for (var i=0, l=children.length; i<l; i++) {
          ...
          if (children_i.nodeType === "text") {
            descartesJS.ctx.font = children_i.style.toString();
            var value = (children_i.value !== "") ? children_i.value : (descartesJS.in_editor) ? "\u200A" : "";
            ...
            Object.defineProperties(children_i.metrics, {
              "x" : { get : function() { 
                return thisLine.metrics.offsetX + this.offsetX;
              } },
              "y" : { get : function() { 
                return thisLine.metrics.offsetY + this.offsetY; 
              } }
            });
          }
          ...
          //////////////////////////////////////////////////////////
            ...
            Object.defineProperties(children_i.metrics, {
              "offsetX" : { get : function() { 
                return thisLine.metrics.offsetX + this.offsetX_aux; 
              } },
              "offsetY" : { get : function() { 
                return thisLine.metrics.offsetY; 
              } },
            });
          }
          ...
          //////////////////////////////////////////////////////////
            ...
            children_i.metrics.marginX = children_i.metrics.marginY = children_i.metrics.paddingX = children_i.metrics.paddingY = 0;
            ...
            Object.defineProperties(children_i.metrics, {
              ...
              "offsetX" : { get : function() { 
                return thisLine.metrics.offsetX +this.marginX +this.offsetX_aux; 
              } },
              "offsetY" : { get : function() { 
                return thisLine.metrics.offsetY; 
              } }
    ...
    updateFormula() {
      ...
      for (var i=0, l=children.length; i<l; i++) {
        ...
        //////////////////////////////////////////////////////////
        if (children_i.nodeType === "text") {
          descartesJS.ctx.font = children_i.style.toString(true);
          var value = (children_i.value !== "") ? children_i.value : (descartesJS.in_editor) ? "\u200A" : "";
          children_i.metrics = getFontMetrics(descartesJS.ctx.font);
          children_i.metrics.w = descartesJS.ctx.measureText(value).width;
          ...
          Object.defineProperties(children_i.metrics, {
            "x" : { get : function() { 
              return thisFormula.metrics.offsetX +thisFormula.metrics.paddingX +this.offsetX; 
            } },
            "y" : { get : function() { 
              return thisFormula.metrics.offsetY; 
            } }
          });
        ...
        //////////////////////////////////////////////////////////
          ...
          Object.defineProperties(children_i.metrics, {
            ...
            "offsetX" : { get : function() { 
              return thisFormula.metrics.offsetX +thisFormula.metrics.paddingX +this.offsetX_aux +this.marginX; 
            } }, 
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY; 
            } },
        ...
        if (children_i.nodeType === "superIndex") {
          ...
          superIndex.metrics.marginX = 0;
          superIndex.metrics.paddingX = 0;
          superIndex.metrics.paddingY = 0;
          ...
          Object.defineProperties(superIndex.metrics, {
            ...
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY +this.ascent +(this.prevChild.metrics.descent -this.prevChild.metrics.ascent)/2 -this.h;
            } },
          });
          ...
          superIndex.metrics.tmp_ascent = superIndex.metrics.h + (superIndex.metrics.prevChild.metrics.ascent - superIndex.metrics.prevChild.metrics.descent)/2;
        ...
        //////////////////////////////////////////////////////////
          ...
          subIndex.metrics.marginX = 0;
          subIndex.metrics.paddingX = 0;
          subIndex.metrics.paddingY = 0;
          ...
          Object.defineProperties(subIndex.metrics, {
            ...
            "offsetX" : { get : function() { 
              return thisFormula.metrics.offsetX +thisFormula.metrics.paddingX +this.offsetX_aux; 
            } },
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY +this.ascent +(this.prevChild.metrics.descent -this.prevChild.metrics.ascent)/2;
            } },
          });
          ...
          this.metrics.descent = subIndex.metrics.ascent +(subIndex.metrics.prevChild.metrics.descent - subIndex.metrics.prevChild.metrics.ascent)/2 +subIndex.metrics.descent;
        ...
        //////////////////////////////////////////////////////////
          ...
          fraction.metrics.marginX = parseInt(0.5 + this.style.size*factorMarginH);
          fraction.metrics.paddingX = 0;
          fraction.metrics.paddingY = 0;
          ...
          Object.defineProperties(fraction.metrics, {
            ...
            "offsetX" : { get : function() { 
              return thisFormula.metrics.offsetX +thisFormula.metrics.paddingX +this.marginX +this.offsetX_aux; 
            } },
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY -offsetY; 
            } },
          });
          ...
          Object.defineProperties(num.metrics, {
            ...
            "offsetX" : { get : function() { 
              return this.parent.metrics.offsetX + parseInt((this.maxWidth - this.w)/2); 
            } },
            "offsetY" : { get : function() { 
              return this.parent.metrics.offsetY - this.descent -this.parent.metrics.paddingY; 
            } },
          });
          ...
          Object.defineProperties(den.metrics, {
            ...
            "offsetY" : { get : function() { 
              return this.parent.metrics.offsetY + this.ascent + this.parent.metrics.paddingY; 
            } },
          });
        ...
        //////////////////////////////////////////////////////////
          ...
          Object.defineProperties(radical.radicalSign, {
            ...
            "x" : { get: function() { 
              return this.parent.metrics.offsetX +this.parent.metrics.paddingX + Math.max(this.displaceIndex, 0); 
            } },
            "y" : { get: function() { 
              return thisFormula.metrics.offsetY -radicand.metrics.ascent; 
            } },
          });
          ...
          Object.defineProperties(index.metrics, {
            ...
            "offsetX" : { get : function() { 
              return this.parent.metrics.offsetX +this.parent.metrics.paddingX + Math.max(this.displaceIndex, 0) -this.displaceIndex; 
            } },
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY -this.descent -2*this.fontSize/5; 
            } },
          });
          ...
          Object.defineProperties(radicand.metrics, {
            ...
            "offsetX" : { get : function() { 
              return this.parent.metrics.offsetX +this.parent.metrics.paddingX +this.parent.radicalSign.w +Math.max(this.displaceIndex, 0) 
            } },
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY; 
            } },
        ...
        //////////////////////////////////////////////////////////
          ...
          Object.defineProperties(sum.sigmaSign, {
            ...
            "x" : { get: function() { 
              return this.parent.metrics.offsetX + this.parent.metrics.paddingX +parseInt((this.sumWidth - this.w)/2); 
            } },
            "y" : { get: function() { 
              return thisFormula.metrics.offsetY +tmpMetric.descent -(this.h +tmpMetric.h)/2; 
            } },
          });
          ...
          Object.defineProperties(sumTo.metrics, {
            ...
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY + this.newBaselineTo; 
            } },
          });
          ...
          Object.defineProperties(sumFrom.metrics, {
            ...
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY + this.newBaselineFrom; 
            } },
          });
          ...
          Object.defineProperties(sumWhat.metrics, {
            ...
            "offsetX" : { get : function() { 
              return this.parent.metrics.offsetX + 2*this.parent.metrics.paddingX +this.sumWidth; 
            } },
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY; 
            } },
        ...
        //////////////////////////////////////////////////////////
          ...
          Object.defineProperties(integralTo.metrics, {
            ...
            "offsetX" : { get : function() { 
              return this.parent.metrics.offsetX + this.parent.metrics.paddingX +parseInt(4*this.integralWidth/5); 
            } },
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY + this.newBaselineTo; 
            } },
          ...
          Object.defineProperties(integralFrom.metrics, {
            ...
            "offsetX" : { get : function() { 
              return this.parent.metrics.offsetX + this.parent.metrics.paddingX +parseInt(2*this.integralWidth/5); 
            } },
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY + this.newBaselineFrom; 
            } },
          ...
          var whatDisplace = Math.max( parseInt(3*integralWidth/5) + integralTo.metrics.w, parseInt(2*integralWidth/5 + integralFrom.metrics.w) ) +integral.metrics.paddingX;
          ...
          Object.defineProperties(integralWhat.metrics, {
            ...
            "offsetX" : { get : function() { 
              return this.parent.metrics.offsetX + this.parent.metrics.paddingX +this.whatDisplace; 
            } },
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY; 
            } },
        ...
        //////////////////////////////////////////////////////////
          ...
          Object.defineProperties(prod.piSign, {
            ...
            "x" : { get: function() { 
              return this.parent.metrics.offsetX + this.parent.metrics.paddingX +parseInt((this.prodWidth - this.w)/2); 
            } },
            "y" : { get: function() { 
              return thisFormula.metrics.offsetY +tmpMetric.descent -(this.h +tmpMetric.h)/2; 
            } },
          ...
          Object.defineProperties(prodWhat.metrics, {
            ...
            "offsetX" : { get : function() { 
              return this.parent.metrics.offsetX + 2*this.parent.metrics.paddingX +this.prodWidth; 
            } },
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY; 
            } },
        ...
        //////////////////////////////////////////////////////////
          ...
          var limitWidth = Math.max(limitTextWidth, limitFrom.metrics.w + arrowWidth + limitTo.metrics.w);
          ...
          Object.defineProperties(limit.limitText, {
            ...
            "x" : { get : function() { 
              return this.parent.metrics.offsetX + this.parent.metrics.paddingX + (this.limitWidth - this.limitTextWidth)/2 
            } },
          });
          ...
          Object.defineProperties(limit.limitArrow, {
            ...
            "x" : { get : function() { 
              return this.parent.metrics.offsetX + this.parent.metrics.paddingX +limitFrom.metrics.w;
            } },
            "y" : { get : function() { 
              return thisFormula.metrics.offsetY + this.newBaseline; 
            } },
          });
          ...
          Object.defineProperties(limitTo.metrics, {
            ...
            "offsetX" : { get : function() { 
              return this.parent.metrics.offsetX + this.parent.metrics.paddingX + limitFrom.metrics.w + this.arrowWidth; 
            } },
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY + this.newBaseline; 
            } },
          ...
          Object.defineProperties(limitWhat.metrics, {
            ...
            "offsetX" : { get : function() { 
              return this.parent.metrics.offsetX + 2*this.parent.metrics.paddingX + this.limitWidth; 
            } },
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY;
            } },
          ...
          var baseline_displace = 0;
          var max_descent = Math.max(limitFrom.metrics.descent, limitTo.metrics.descent, limitWhat.metrics.descent);
          if ((limitFrom.metrics.h != 0) || (limitTo.metrics.h != 0)) {   
            baseline_displace = newBaseline;
            max_descent = Math.max(limitFrom.metrics.descent, limitTo.metrics.descent, (max_descent-baseline_displace));
          }
          limit.metrics.descent = baseline_displace +max_descent  +limit.metrics.paddingY;
        ...
        //////////////////////////////////////////////////////////
          ...
          for (var j=0, k=rows*cols; j<k; j++) {
            ...
            Object.defineProperties(components[j].metrics, {
              ...
              "offsetX" : { get : function() { 
                return this.parent.metrics.offsetX + this.parent.metrics.paddingX + this.offsetX_aux; 
              } },
              "offsetY" : { get : function() { 
                return thisFormula.metrics.offsetY - this.matrixH/2 + this.ascent + this.offsetY_aux + this.dispY; 
              } },
            });
          }
        ...
        //////////////////////////////////////////////////////////
          ...
          Object.defineProperties(defparts.metrics, {
            ...
            "x" : { get : function() { 
              return this.offsetX -2*this.marginX; 
            } },
            "y" : { get : function() { 
              return this.offsetY; 
            } },
            ...
            "offsetX" : { get : function() { 
              return thisFormula.metrics.offsetX +thisFormula.metrics.paddingX +3*this.marginX +this.offsetX_aux; 
            } },
            "offsetY" : { get : function() { 
              return thisFormula.metrics.offsetY; 
            } },
          ...
          for (var j=0; j<parts; j++) {
            ...
            Object.defineProperties(components[j].metrics, {
              ...
              "offsetY" : { get : function() { 
                return thisFormula.metrics.offsetY - this.parent.metrics.defpartsH/2 +this.ascent +this.offsetY_aux + this.dispY; 
              } },
            });
          }
        ...
        //////////////////////////////////////////////////////////
          ...
          if ((children_i.children.length == 1) && (children_i.children[0].nodeType == "text") && (children_i.children[0].value == "")) {
             children_i.metrics.w = 0;
             if (!descartesJS.in_editor) {
               children_i.metrics.ascent = children_i.metrics.descent = children_i.metrics.h = 0;
             }
          }
          else {
            children_i.metrics.w += 2*children_i.metrics.paddingX;
        ...
        var tmp_ascent = children_i.metrics.tmp_ascent || children_i.metrics.ascent;
        this.metrics.ascent = Math.max(this.metrics.ascent, tmp_ascent);
        this.metrics.descent = Math.max(this.metrics.descent, children_i.metrics.descent);
    ...
    drawTextBlock(ctx) {
      ...
      // reset the shadow color to prevent drawing shadows in other shapes
    ...
    drawText(ctx) {
      ...
      ctx.font = this.style.toString(inside_formula);
